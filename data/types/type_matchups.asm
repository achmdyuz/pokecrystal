TypeMatchups:
	...
	; KAMI TYPE IS IMMUNE AGAIN EVERYTHING
    ...
    db GRASS,        KAMI,         NOT_VERY_EFFECTIVE 
    ...
    db BUG,          KAMI,         NOT_VERY_EFFECTIVE 
